	...
	<div class="cf-callout">
		<div id="cf-callout-credit" class="cf-box">
			...
			<div class="cf-box-content">
				<p class="txt-center"><a href="http://crowdfavorite.com/" title="Crowd Favorite : Elegant WordPress and Web Application Development"><img src="'.$img_dir_url.'cf-logo.png" alt="Crowd Favorite"></a></p>
